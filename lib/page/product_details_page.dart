...
import 'package:ecommerce_b6_n/models/purchase_model.dart';
import 'package:ecommerce_b6_n/utils/helper_functions.dart';
            ...
            return ListView(
              children: [
                FadeInImage.assetNetwork(
                  placeholder: 'images/progressbar.gif',
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                provider.addNewPurchase(purchase,productModel.category!).then((value) {
                  qController.clear();
